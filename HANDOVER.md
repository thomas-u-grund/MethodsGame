...
- **Next candidates for rigs:** the Doorman stepping out of the gate, the Sampling Officer striding to the drum, the Fieldwork Director pacing — same pipeline (parts sheet in the cast's ChatGPT chat → split/scale → `*_RIG` definition).
